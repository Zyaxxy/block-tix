  ...
  return <header className="border-b bg-card">
      <div className="container mx-auto px-4 flex items-center justify-between h-16">
        <div className="flex items-center space-x-4">
          <Button variant="ghost" size="icon" className="md:hidden" onClick={() => setIsBurgerMenuOpen(true)}>
          ...
          <img src="/logo.png" alt="Block Tix" className="h-12 w-12" />
            <span className="font-serif text-xl hidden sm:inline-block font-semibold">BlockTix</span>
          </Link>
          
          <nav className="font-serif hidden md:flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-4">
          {isWalletCreated && walletAddress ? <>
              <Button variant="purple" size="icon" className="relative">
